...
function verifierProbeContract(content) {
  ...
  // Sections legitimately added between 7c and 8 (this fork's Step 7-ADR and
  // intermediate-bets sections) carry their own numbered lists; scanning to
  // Step 8 swept those into the executionSteps assertion. Scope to Step 7c's
  // own content (#3321 — re-applied after upstream folded the standalone
  // bug-3321 file into this consolidated suite in #1976).
