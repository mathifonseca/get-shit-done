...
| `/gsd-sdlc-audit` | Audit project against SDLC checklist; shows what's set up, what's missing, what's next. | [commands/gsd/sdlc-audit.md](../commands/gsd/sdlc-audit.md) |
