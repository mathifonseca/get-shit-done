...
Read and execute `gsd-core/workflows/execute-phase/steps/propagate-execution-decisions.md`.
Self-guards on `workflow.update_claude_md_on_complete`; silent no-op when off.
</step>
